		...
		<div class="row">
			<div class="info">
				<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
					<div class="heading">
						<h3 class="heading-title">DigiCyp</h3>
						<div class="heading-line">
							<span class="short-line"></span>
							<span class="long-line"></span>
						</div>
						<p class="heading-text">
                            <?= lang ('home.shortAbout') ?>
						</p>
					</div>
					<div class="socials">
						<a href="" class="social__item">
							<img loading="lazy" src="<?= base_url () ?>/assets/svg/circle-facebook.svg" alt="<?= lang ('seoPage.homeT') ?>">
						</a>
						<a href="" class="social__item">
							<img loading="lazy" src="<?= base_url () ?>/assets/img/instagram.png" alt="<?= lang ('seoPage.homeT') ?>">
						</a>
						<a href="" class="social__item">
							<img loading="lazy" src="<?= base_url () ?>/assets/svg/rss.svg" alt="<?= lang ('seoPage.homeT') ?>">
						</a>
					</div>
				</div>
				<div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12">
					<div class="services">
						<div class="heading">
							<h3 class="heading-title"><?= lang ('footer.service')  ?></h3>
							<div class="heading-line">
								<span class="short-line"></span>
								<span class="long-line"></span>
							</div>
						...
						<ul class="list list--primary">
							<li>
								...
								<a href="<?= base_url ('local-SEO') ?>" title="<?= lang ('seoPage.localT') ?>"><?= lang ('home.local_seo')  ?></a>
							</li>
							<li>
								<i class="fa fa-caret-right" aria-hidden="true"></i>
								<a href="<?= base_url ('Email-Marketing') ?>" title="<?= lang ('seoPage.emailT') ?>"><?= lang ('home.email_marketing')  ?></a>
							</li>
							<li>
								<i class="fa fa-caret-right" aria-hidden="true"></i>
								<a href="<?= base_url ('Social-Media-Marketing') ?>" title="<?= lang ('seoPage.socialT') ?>"><?= lang ('home.social_media_marketing')  ?></a>
							</li>
                            <li>
                                <i class="fa fa-caret-right" aria-hidden="true"></i>
                                <a href="<?= base_url ('Video-Editing-Services') ?>" title="<?= lang ('seoPage.videoT') ?>"><?= lang ('home.edit')  ?></a>
                            </li>
						</ul>
						<ul class="list list--primary">
                            <li>
                                <i class="fa fa-caret-right" aria-hidden="true"></i>
                                <a href="<?= base_url ('Website-Design') ?>" title="<?= lang ('seoPage.webT') ?>"><?= lang ('home.web_design')  ?></a>
                            </li>
							<li>
								<i class="fa fa-caret-right" aria-hidden="true"></i>
								<a href="<?= base_url ('search-engine-optimization-seo') ?>" title="<?= lang ('seoPage.seoT') ?>"><?= lang ('home.search_engine_optimization')  ?></a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="contacts">
				<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<div class="contacts-item">
						...
						<div class="content">
							<a href="tel:+90 548 856 1912" class="title" title="<?= lang ('seoPage.homeT') ?>">+90 548 856 1912</a>
							<p class="sub-title"><?= lang ('topBar.Mon_Fri')  ?> 9:00-20:00</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<div class="contacts-item">
						...
						<div class="content">
							<a href="mailto:info@digicyp.com" class="title" title="<?= lang ('seoPage.homeT') ?>">info@digicyp.com</a>
				...
				<div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
					<div class="contacts-item">
						...
						<div class="content">
							<a href="javascript: void (0)" class="title" title="<?= lang ('seoPage.homeT') ?>"><?= lang ('footer.address')  ?></a>
							<p class="sub-title"></p>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <span>
                    Copyright © <?= date ('Y') ?> <a href="<?= base_url () ?>" target="_blank" class="sub-footer__link" title="<?= lang ('seoPage.homeT') ?>">DigiCyp</a>
                    </span>
...
<div class="window-popup">
	...
	<div class="sign-in-popup">
		<h5 class="title">Register to DigiCyp</h5>
	...
	<div class="container">
		<div class="row">
			<div class="form_search-wrap">
				<form>
					<input class="overlay_search-input" placeholder="<?= lang ('footer.search') ?>..." type="text">
